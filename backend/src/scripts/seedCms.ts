...
const HeroModel = Hero as any;
const StatModel = Stat as any;
const ServiceModel = Service as any;
const ProcessStepModel = ProcessStep as any;
const TechStackItemModel = TechStackItem as any;
const TestimonialModel = Testimonial as any;
const WhyUsReasonModel = WhyUsReason as any;
const BlogPostModel = BlogPost as any;
const FaqModel = Faq as any;
const NavigationModel = Navigation as any;
const FooterContentModel = FooterContent as any;
const SiteSettingsModel = SiteSettings as any;
