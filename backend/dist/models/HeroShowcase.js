...
const ShowcaseItemSchema = new mongoose_1.Schema({
    project: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Project', required: true },
    isEnabled: { type: Boolean, default: true },
    isFeatured: { type: Boolean, default: false },
    order: { type: Number, default: 0 }
});
const HeroShowcaseSchema = new mongoose_1.Schema({
...
exports.default = mongoose_1.default.models.HeroShowcase || mongoose_1.default.model('HeroShowcase', HeroShowcaseSchema);
