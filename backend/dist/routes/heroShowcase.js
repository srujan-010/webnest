...
const HeroShowcase_1 = __importDefault(require("../models/HeroShowcase"));
const router = (0, express_1.Router)();
const ctrl = (0, crudFactory_1.createCrudController)(HeroShowcase_1.default, 'HeroShowcase', { populate: 'featuredProjects.project' });
