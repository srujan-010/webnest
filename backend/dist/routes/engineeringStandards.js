...
const EngineeringStandard_1 = __importDefault(require("../models/EngineeringStandard"));
const router = (0, express_1.Router)();
const ctrl = (0, crudFactory_1.createCrudController)(EngineeringStandard_1.default, 'EngineeringStandard');
