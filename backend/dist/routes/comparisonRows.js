...
const ComparisonRow_1 = __importDefault(require("../models/ComparisonRow"));
const router = (0, express_1.Router)();
const ctrl = (0, crudFactory_1.createCrudController)(ComparisonRow_1.default, 'ComparisonRow');
