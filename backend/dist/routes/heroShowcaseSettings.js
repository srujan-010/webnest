...
const HeroShowcaseSettings_1 = __importDefault(require("../models/HeroShowcaseSettings"));
const router = (0, express_1.Router)();
const ctrl = (0, crudFactory_1.createCrudController)(HeroShowcaseSettings_1.default, 'HeroShowcaseSettings');
